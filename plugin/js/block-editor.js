(function(wp, _) {
    ...
    var RangeControl = withInstanceId(function(_ref) {
        var label = _ref.label, instanceId = _ref.instanceId, setAttributes = _ref.setAttributes, timer = _ref.timer;
    ...
    function DesignControls(_ref2) {
        var _el;
        var attributes = _ref2.attributes, setAttributes = _ref2.setAttributes, setTimeout = _ref2.setTimeout, resolving = _ref2.resolving, list = _ref2.list;
        ...
        return el(React.Fragment, null, faulty.shortcode && el(Components.Notice, {
            ...
            options: modeOptions
        }, _defineProperty(_el, "className", faulty.mode || faulty.solve ? "crw-control-error" : undefined), 
        _defineProperty(_el, "help", faulty.mode ? __("Select something.", "crosswordsearch") : faulty.solve ? sprintf(__("There is no crossword in project %1$s.", "crosswordsearch"), attributes.project) : undefined), 
        _defineProperty(_el, "onChange", function onChange(newValue) {
            var newAttrs = {
                mode: newValue
            };
            if (newValue === "build") {
